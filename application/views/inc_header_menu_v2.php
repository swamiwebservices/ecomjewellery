    ...
    <div class="header_middel sticky-header">
        <div class="container-fluid">
            <div class="row align-items-center" style="position:relative">
                ...
                <div class="col-lg-11 col-md-11 col-sm-12 col-8" style="position:absolute;bottom:0;right:0">
                    <div class="main_menu_inner" style="text-align:center;bottom: -15px;position: absolute;">
