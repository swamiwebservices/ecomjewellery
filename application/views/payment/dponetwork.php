  ...
  <form action="<?php echo $action ?>" method="post" id="dponetwork_form" name="dponetwork_form">
  ...
  $('#button-confirm').on('click', function() {
        ...
        if (shipping_payment_error != "") {
            ...
            $.ajax({
                ...
                data: dataString,
                cache: false,
                url: '<?php echo site_url("dponetwork/confirm")?>',
                cache: false,
                beforeSend: function() {
                ...
                success: function(dataresp) {
                    ...
                    if (dataresp.status == "1") {
                     ...
                     //   $("#dponetwork_form").attr('action', dataresp.options.callback_url);
                     window.location.href = dataresp.options;
