...
<head>
    ...
    <title>Monsta - shop right sidebar list</title>
                ...
                <div class="col-lg-9 col-md-12">
                    ...
                    <div class="shop_toolbar">
                        <div class="list_button">
                            <ul class="nav" role="tablist">
                                <li>
                                    <a  data-bs-toggle="tab" href="#large" role="tab" aria-controls="large" aria-selected="true"><i class="ion-grid"></i></a>
                                </li>
                                <li>
                                    <a class="active" data-bs-toggle="tab" href="#list" role="tab" aria-controls="list" aria-selected="false"><i class="ion-ios-list-outline"></i> </a>
                                </li>
                            </ul>
                        </div>
                    ...
                    <!--shop tab product start-->
                     <div class="tab-content">
                        <div class="tab-pane grid_view fade " id="large" role="tabpanel">
                            <div class="row">
