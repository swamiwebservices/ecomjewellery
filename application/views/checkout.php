                    ...
                    <div class="row">
                        <div class="col-lg-7 col-md-7">
                            ...
                            <div id="billing_address_div">
                                <?php print_r($shipping_address); echo (isset($payment_address)) ? $payment_address : ''; ?>
                            </div>
                            ...
                            <div id="shipping-new">
                                ...
                                <div class="row row-cols-1 row-cols-md-2">
                                    ...
                                    <div class="col mb-3 required">
                                        ...
                                        <input type="text" name="shipping_firstname" value="<?php echo (isset($shipping_address['shipping_firstname'])) ? $shipping_address['shipping_firstname'] : ''?>" placeholder="First Name"
                                            id="input-shipping-firstname" class="form-control" required>
                                    ...
                                    <div class="col mb-3 required">
                                        <label for="input-shipping-lastname" class="form-label">Last Name</label> <input
                                            type="text" name="shipping_lastname" value="<?php echo (isset($shipping_address['shipping_lastname'])) ? $shipping_address['shipping_lastname'] : ''?>" placeholder="Last Name"
                                            id="input-shipping-lastname" class="form-control" required>
                                    ...
                                    <div class="col-md-12 mb-3">
                                        <label for="input-shipping-company" class="form-label">Company
                                            (Optional)</label>
                                        <input type="text" name="shipping_company" value="<?php echo (isset($shipping_address['shipping_company'])) ? $shipping_address['shipping_company'] : ''?>" placeholder="Company (optional)"
                                    ...
                                    <div class="col-md-12 mb-3 required">
                                        ...
                                        <input type="text" name="shipping_address_1" value="<?php echo (isset($shipping_address['shipping_address_1'])) ? $shipping_address['shipping_address_1'] : ''?>" placeholder="Address 1"
                                            id="input-shipping-address-1" class="form-control" required>
                                    ...
                                    <div class="col-md-12 mb-3 required">
                                        <label for="input-shipping-address-1" class="form-label">Address2
                                            (optional)</label>
                                        <input type="text" name="shipping_address_2" value="<?php echo (isset($shipping_address['shipping_address_2'])) ? $shipping_address['shipping_address_2'] : ''?>"
                                    ...
                                    <div class="co-md-12 mb-3 required">
                                        ...
                                        <select name="shipping_country_id" id="input-shipping-country" class="form-select" required>
                                    ...
                                    <div class="col mb-3 required">
                                        ...
                                        <select name="shipping_zone_id" id="input-shipping-zone" class="form-select" required>
                                            <option value=""> --- Please Select --- </option>
                                    ...
                                    <div class="co-md-4 mb-3 required">
                                        ...
                                        <input type="text" name="shipping_city" value="<?php echo (isset($shipping_address['shipping_city'])) ? $shipping_address['shipping_city'] : ''?>" placeholder="City"
                                            id="input-shipping-city" class="form-control" required>
                                        <div id="error-shipping-city" class="invalid-feedback"></div>
                                    </div>

                                    <div class="co-md-4 mb-3 required">
                                        <label for="input-shipping-postcode" class="form-label">Post Code</label>
                                        <input type="text" name="shipping_postcode" value="<?php echo (isset($shipping_address['shipping_postcode'])) ? $shipping_address['shipping_postcode'] : ''?>" placeholder="Post Code"
                                            id="input-shipping-postcode" class="form-control" required>
                            ...
                            <div id="checkout-confirm">
                                ...
                                <div id="checkout-payment">
                                    <div class="d-inline-block pt-2 pd-2 w-100 text-end">
                                        <button type="submit" id="button-confirm" class="btn btn-primary">Confirm
                                            Order</button>
                                    </div>
