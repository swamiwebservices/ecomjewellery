...
<head>
    ...
    <title>Monsta - product grouped</title>
                               ...
                               <h1>Donec eu furniture</h1>
                                ...
                                <div class="grouped_form table-responsive">
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td class="grouped-product-list quantity"><input type="checkbox"></td>
                                                <td class="grouped-product-list label"><a href="#">Shave Brush</a></td>
                                                <td class="grouped-product-list price"><del>123.00</del> 99.00</td>
                                            </tr>
                                            <tr>
                                                <td class="grouped-product-list quantity"><input min="1" value="1" max="100" type="number"></td>
                                                <td class="grouped-product-list label"><a href="#">Aftershave Lotion</a></td>
                                                <td class="grouped-product-list price">$80.00</td>
                                            </tr>
                                            <tr>
                                                <td class="grouped-product-list quantity"><input min="1" value="1" max="100" type="number"></td>
                                                <td class="grouped-product-list label"><a href="#">White Shave Brush</a></td>
                                                <td class="grouped-product-list price">$119.00  <p>198 in stock</p></td>
                                            </tr>
                                        </tbody>
                                    </table>
