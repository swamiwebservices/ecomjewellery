		...
		$.ajax({
			...
			success: function(json) {
				...
				if (json['success']) {
                    ...
                    $('#addToWishModal_body').html('<div class="container"><div class="alert alert-success"><i class="fa fa-check-circle"></i> ' + json['success'] + '</div></div>');
				}
				...
				if (json['info']) {
                    ...
                    $('#addToWishModal_body').html('<div class="container"><div class="alert alert-info"><i class="fa fa-info-circle"></i> ' + json['info'] + '</div></div>');
				}
