...
//error_reporting(0);
class Captchalkishore extends CI_Controller {
  ...
  //public $resourcesPath = 'D:/xampp74/htdocs/cetbiz.com/cetbiz/resources';
    ...
    public $session_var = 'captchaWordnew';
     ...
     */
    public $fonts = array(
        'Antykwa'  => array('spacing' => 3, 'minSize' => 18, 'maxSize' => 18, 'font' => 'TimesNewRomanBold.ttf'),
    ...
    protected function GetCaptchaText() {
        $text =    substr(number_format(time() * rand(),0,'',''),0,4);//$this->GetDictionaryCaptchaText();
        if (!$text) {
    ...
    protected function WriteText($text, $fontcfg = array()) {
        ...
        $fontfile = FCPATH.$this->resourcesPath.'/fonts/'.$fontcfg['font'];
