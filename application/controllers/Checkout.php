...
class Checkout extends CI_Controller
{
    ...
    public function index()
    {
       ...
       // print_r($customer_info);
        ...
        if(isset($_POST['mode']) && $_POST['mode']=="checkout"){
            ...
            if($error==""){
               ...
               // $order_data['total'] = $total = (isset($_POST['total'])) ? $this->input->post('total') : '';
                ...
                $data['shipping_address']['shipping_firstname'] = $this->input->post('shipping_firstname');
                $data['shipping_address']['shipping_lastname'] = $this->input->post('shipping_lastname');
                $data['shipping_address']['shipping_company'] = $this->input->post('shipping_company');
                $data['shipping_address']['shipping_address_1'] = $this->input->post('shipping_address_1');
                $data['shipping_address']['shipping_address_2'] = $this->input->post('shipping_address_2');
                $data['shipping_address']['shipping_country_id'] = $this->input->post('shipping_country_id');
                $data['shipping_address']['shipping_zone_id'] = $this->input->post('shipping_zone_id');
                $data['shipping_address']['shipping_city'] = $this->input->post('shipping_city');
                $data['shipping_address']['shipping_postcode'] = $this->input->post('shipping_postcode');
