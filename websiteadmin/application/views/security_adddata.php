    ...
    ?>
                    ...
                    <div class="card">
                        ...
                        <form name="frm-edit" id="frm-edit" action="<?php echo site_url($controller . '/adddata/') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="middle_name">Middle Name :</label>
...
<div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">   <select class="form-control" name="gender" id="gender" required1>
	                                        ...
	                                        <option value='Male' <?php echo (isset($records['gender']) && $records['gender']=='Male') ? ' selected' : ''; ?>> Male</option>
                                            <option value='Female' <?php echo (isset($records['gender']) &&  $records['gender']=='Female') ? ' selected' : ''; ?>> Female</option>
                                        </select> </div>
                                </div>
                                <div class="form-group row">
