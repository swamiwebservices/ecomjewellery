                    ...
                    <div class="card-body">
                        <form class="form-horizontal" id="blogform1" name="blogform1" method="post"
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-md-2 control-label" for="free_shipping"> Free Shipping :<span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-4"><input type="text" class="form-control  " id="free_shipping"
                                        name="free_shipping" placeholder="free_shipping"
                                        value="<?php echo isset($records['free_shipping'])?$this->common->getDbValue($records['free_shipping']):''; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-md-2 control-label" for="shipping_charge"> Free Shipping :<span
                                        class="text-danger">*</span></label>
                                <div class="col-lg-4"><input type="text" class="form-control  " id="shipping_charge"
                                        name="shipping_charge" placeholder="shipping_charge"
                                        value="<?php echo isset($records['shipping_charge'])?$this->common->getDbValue($records['shipping_charge']):''; ?>">
