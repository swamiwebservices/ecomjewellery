...
if ($status == "Inactive") {echo '<span class="badge badge-light">Inactive</span>';}
        ?>
                                    ...
                                    <td align="center" class="text-center">
                                        ...
                                        <a href="<?php echo site_url($controller . '/addDistrict/' . $value['id']) ?>" class="list-icons-item text-primary-600 " data-popup="tooltip" title="" data-original-title="Add district area"><i class="icon-add"></i></a> |    <a href="<?php echo site_url($controller . '/editprovince/' . $value['id']) ?>" class="list-icons-item text-primary-600 ml-2" data-popup="tooltip" title="" data-original-title="Edit"><i class="icon-pencil7"></i></a>   
