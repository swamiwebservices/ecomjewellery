                    ...
                    <?php }?>
                        ...
                        <input type="hidden" name="mode" id="mode" value="maintenancemode">
                             ...
                             <div class="form-group row">
                                    <label class="col-lg-2 col-form-label" for="address">Maintenance Mode <span class="text-danger">*</span></label>
                                    <div class="col-lg-6 col-sm-12 ">
                                    <select name="config_maintenance" id="config_maintenance" class="form-control">
                                    <option value="1" <?php echo (isset($records['config_maintenance']) && $records['config_maintenance']=="1")?'selected':''; ?>>Yes</option>
                                    <option value="0" <?php echo (isset($records['config_maintenance']) && $records['config_maintenance']=="0")?'selected':''; ?>>No</option>
                                    </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                <label class="control-label col-sm-2" for="config_site_maintenance_message">Maintenance message:</label>
                                <div class="col-sm-10">
                                   <textarea  class="form-control" name="config_site_maintenance_message" id="config_site_maintenance_message"   placeholder="Maintenance message"  ><?php echo isset($records['config_site_maintenance_message'])?$this->common->getDbValue($records['config_site_maintenance_message']):''; ?></textarea>
                                </div>
                              </div>     
