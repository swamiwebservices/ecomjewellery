...
<?php }?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form name="frm-edit" id="frm-edit" action="<?php echo site_url($controller . '/editcoupondata/'.$uuid) ?>" method="post" enctype="multipart/form-data"  >

                            
<input type="hidden" name="mode" id="mode" value="edit_content_add">
<input type="hidden" name="code_old" id="code_old" value="<?php echo isset($records['code']) ? $this->common->getDbValue($records['code']) : ''; ?>">

                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="name">Name :<span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                    
                                    <input type="text" class="form-control" id="name" name="name" placeholder="" value="<?php echo isset($records['name']) ? $this->common->getDbValue($records['name']) : ''; ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9"><input type="text" class="form-control" id="code" name="code" placeholder="" value="<?php echo isset($records['code']) ? $this->common->getDbValue($records['code']) : ''; ?>"   required1> </div>
                                </div>
                    ...
                    <?php } ?>
                             ...
                             <!--  <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9"><input type="text" class="form-control numbersOnly" id="uses_customer" name="uses_customer" placeholder="" value="<?php echo isset($records['uses_customer']) ? $this->common->getDbValue($records['uses_customer']) : ''; ?>" required1> </div>
                                </div>
                                <div class="form-group row">
