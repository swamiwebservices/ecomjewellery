...
if ($warning) {
    ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="frm-edit" id="frm-edit" action="<?php echo site_url($controller . '/editnotification/'.$email_id) ?>" method="post" enctype="multipart/form-data"  >
                                <input type="hidden" name="mode" id="mode" value="submitform">
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="description">Template :<span class="text-danger">*</span></label>
                                    <div class="col-lg-9">
                                    <textarea rows="10" cols="3" class="form-control" placeholder="Template" id="description" name="description"><?php echo isset($records['description'])?$this->common->getDbValue($records['description']):''; ?></textarea>
