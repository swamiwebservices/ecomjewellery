                    ...
                    <div class="card  ">
						...
						<table width="100%" class="table table-hover datatable-responsive">
		                    ...
		                    <tbody>
								...
								/*$where_cond = "where auto_id=".$value['user_type_id'];
								$type_rs = $this->common->getOneRow('mst_user_type',$where_cond);

								$where_cond = "where auto_id=".$value['club_id'];
								$club_rs = $this->common->getOneRow('mst_clubs',$where_cond);*/
								$status = $this->common->getDbValue($value['user_status']);
																	
								?>                            
		                        <tr class="<?php if($status=="Active"){?>table-success<?php } else { ?>table-danger<?php } ?>">
		                            <td valign="top"><?php echo $i?></td>
		                            <td valign="top"><a href="#"><strong>
		                            ...
		                            <td valign="top"><strong>Address :</strong> <?php echo $this->common->getDbValue($value['address']); ?><br>
                                      <strong>City :</strong> <?php echo $this->common->getDbValue($value['city']); ?><br>
                                      <strong>State :</strong> <?php echo $this->common->getDbValue($value['state_name_code']); ?><br>
                                    <strong>Pin Code:</strong> <?php echo $this->common->getDbValue($value['pincode']); ?></td>
		                            <td valign="top"><?php echo $this->common->getDbValue($value['user_gender']); ?></td>
		                            <td valign="top">
                                        <?php
