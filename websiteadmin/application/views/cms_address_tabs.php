                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane fade  <?php echo  (isset($ind) && $ind==1) ? ' show active' : '' ?>"
                                ...
                                <form name="frm-edit" id="frm-edit"
                                    ...
                                    <input type="hidden" name="name_heading_old" id="name_heading_old"
                                        value="<?php echo isset($records[$key]['name_heading']) ? $records[$key]['name_heading'] : ''; ?>">
                                        <input type="hidden" name="domains" id="domains"
                                        value="<?php echo isset($key) ? $key : ''; ?>">

                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label" for="address">Address 1 <span
                                                class="text-danger">*</span></label>
                                        <div class="col-lg-10">
                                            <textarea rows="3" cols="3" class="form-control " placeholder="Address 1 "
                                                id="address"
                                                name="address"><?php echo isset($records[$key]['address'])?$this->common->getDbValue($records[$key]['address']):''; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea rows="3" cols="3" class="form-control " placeholder="Address 2 "
                                                id="address2"
                                                name="address2"><?php echo isset($records[$key]['address2'])?$this->common->getDbValue($records[$key]['address2']):''; ?></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control alhanumeric1 maxlength-textarea"
                                                maxlength="200" name="email1" id="email1"
                                                value="<?php echo isset($records[$key]['email1']) ? $records[$key]['email1'] : ''; ?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control alhanumeric1 maxlength-textarea"
                                                maxlength="200" name="phone1" id="phone1"
                                                value="<?php echo isset($records[$key]['phone1']) ? $records[$key]['phone1'] : ''; ?>"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control alhanumeric1 " name="map_long"
                                                id="map_long"
                                                value="<?php echo isset($records[$key]['map_long']) ? $records[$key]['map_long'] : ''; ?>"
                                                placeholder="Map long">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label class="col-lg-2 col-form-label" for="map_lat">Map lat.</label>
                                        <div class="col-lg-10">
                                            <input type="text" class="form-control alhanumeric1 " name="map_lat"
                                                id="map_lat"
                                                value="<?php echo isset($records[$key]['map_lat']) ? $records[$key]['map_lat'] : ''; ?>"
                                                placeholder="Map lat">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-10">
                                            <textarea rows="2" cols="5" name="google_map" id="google_map"
                                                class="form-control"
                                                placeholder="Google map"><?php echo isset($records[$key]['google_map']) ? $records[$key]['google_map'] : ''; ?></textarea>
                                        </div>
                                    </div>
                                    <div class="form-group row">
