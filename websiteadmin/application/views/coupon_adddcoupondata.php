                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form name="frm-edit" id="frm-edit"
                            action="<?php echo site_url($controller . '/adddcoupondata') ?>" method="post"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name" placeholder=""
                                        value="<?php echo isset($_POST['name']) ? $this->common->getDbValue($_POST['name']) : ''; ?>">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9"><input type="text" class="form-control" id="code" name="code"
                                        placeholder=""
                                        value="<?php echo isset($_POST['code']) ? $this->common->getDbValue($_POST['code']) : ''; ?>"
                                        required1> </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9"><input type="text" class="form-control" id="discount"
                                        ...
                                        value="<?php echo isset($_POST['discount']) ? $this->common->getDbValue($_POST['discount']) : ''; ?>"
                                        required1> </div>
                            </div>
                            <!--   <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9"><input type="text" class="form-control numbersOnly"
                                        id="date_start" name="date_start" placeholder=""
                                        value="<?php echo isset($_POST['date_start']) ? $this->common->getDbValue($_POST['date_start']) : ''; ?>"
                                        required1> </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="date_end">Date End : </label>
                                <div class="col-lg-9"><input type="text" class="form-control numbersOnly" id="date_end"
                                        name="date_end" placeholder=""
                                        value="<?php echo isset($_POST['date_end']) ? $this->common->getDbValue($_POST['date_end']) : ''; ?>"
                                        required1> </div>
                            </div>
                            <div class="form-group row">
                                <label class="col-form-label col-lg-2" for="total" data-popup="tooltip" title=""
                                    data-original-title="The maximum number of times the coupon can be used by any customer. Leave blank for unlimited">Uses
                                    Per Coupon : </label>
                                <div class="col-lg-9"><input type="text" class="form-control numbersOnly" id="total"
                                        name="total" placeholder=""
                                        value="<?php echo isset($_POST['total']) ? $this->common->getDbValue($_POST['total']) : ''; ?>"
                                        required1> </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-9"><input type="text" class="form-control numbersOnly"
                                        ...
                                        value="<?php echo isset($_POST['uses_customer']) ? $this->common->getDbValue($_POST['uses_customer']) : ''; ?>"
                                        required1> </div>
                            </div>
                            <div class="form-group row">
