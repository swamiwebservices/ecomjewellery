...
if ($error_warning) {
 ...
 ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="frm-edit" id="frm-edit" action="<?php echo site_url($controller . '/adddcoupondata') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9">
                                        ...
                                        <input type="text" class="form-control" id="name" name="name" placeholder="" value="<?php echo isset($_POST['name']) ? $this->common->getDbValue($_POST['name']) : ''; ?>">

                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="code" data-popup="tooltip" title="" data-original-title="The code the customer enters to get the discount.">Code :<span class="text-danger">*</span></label>
                                    <div class="col-lg-9"><input type="text" class="form-control" id="code" name="code" placeholder="" value="<?php echo isset($_POST['code']) ? $this->common->getDbValue($_POST['code']) : ''; ?>" required1> </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="Type" data-popup="tooltip" title="" data-original-title="Percentage or Fixed Amount.">Type :</label>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9"><input type="text" class="form-control numbersOnly" id="date_end" name="date_end" placeholder="" value="<?php echo isset($_POST['date_end']) ? $this->common->getDbValue($_POST['date_end']) : ''; ?>" required1> </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="uses_customer" data-popup="tooltip" title="" data-original-title="The maximum number of times the coupon can be used by a single customer. Leave blank for unlimited">Uses Per Customer : </label>
                                    <div class="col-lg-9"><input type="text" class="form-control numbersOnly" id="uses_customer" name="uses_customer" placeholder="" value="<?php echo isset($_POST['uses_customer']) ? $this->common->getDbValue($_POST['uses_customer']) : ''; ?>" required1> </div>
                                </div>
                                <div class="form-group row">
