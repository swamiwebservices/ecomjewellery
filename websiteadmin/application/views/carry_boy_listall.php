...
if ($status == "Inactive") {echo '<span class="badge badge-light">Inactive</span>';}
        ?>
                                    ...
                                    <td class="text-center">
                                        <div class="list-icons">
                                            ...
                                            <a href="#" class="list-icons-item text-danger-600 bootbox_custom" data-cbuid="<?php echo $value['user_id'] ?>" data-popup="tooltip" title="" data-original-title="Delete"><i class="icon-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php }?>
    ...
    ?>
        ...
        $('.bootbox_custom').on('click', function() {
            var cbuid = $(this).data("cbuid") // will return the number 123
            bootbox.confirm({
                title: 'Confirm ',
                ...
                callback: function(result) {
                    if (result) {
                        ...
                        location.href = "<?php echo site_url($controller . '/delete_data/') ?>" + cbuid;
