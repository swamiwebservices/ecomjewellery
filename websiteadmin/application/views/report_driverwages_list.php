    ...
    ?>
                        ...
                        <table class="table table-hover datatablecustom">
                            ...
                            <tbody>
								...
								$i++;
                              $total_wages = $value['total_wages']  * 1;
                              $total_wages_paid = abs($value['total_wages_paid'])  ;
                              $balance_wages = $value['balance_wages']  * 1;

								?>
                                <tr class="  border-left-3  <?php echo ($balance_wages > 0) ? 'border-left-danger' : 'border-left-success' ?> ">
                                    ...
                                    <td  class="text-right "><?php echo $total_wages; ?></td>
                                    <td  class="text-right "><?php echo $total_wages_paid   ; ?></td>
                                    <td class="text-right "><?php echo $balance_wages; ?></td>
                                    <td valign="top">
                                        <div class="list-icons">
                                            <a href="<?php echo site_url('reports/wages_history/'.$this->common->getDbValue($value['user_id'])) ?>" class="list-icons-item text-primary-600" data-popup="tooltip" title="" data-original-title="View"><i class="icon-file-eye "></i></a>
                                        </div>
                                    </td>
