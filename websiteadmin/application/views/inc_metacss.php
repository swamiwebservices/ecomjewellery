...
<script type="text/javascript" src="<?php echo base_url() ?>assets/summernote/summernote-image-attributes.js"></script>
...
<!-- <script src="<?php echo base_url() ?>global_assets/js/plugins/editors/ckeditor/ckeditor.js"></script>
 --> 	 
<script src="<?php echo base_url() ?>global_assets/js/plugins/forms/inputs/inputmask.js"></script>
          
	<script src="<?php echo base_url() ?>global_assets/js/plugins/extensions/jquery_ui/core.min.js"></script>


    <script src="<?php echo base_url() ?>global_assets/js/plugins/forms/inputs/passy.js"></script>
    ...
    <script src="<?php echo base_url() ?>global_assets/js/plugins/forms/inputs/typeahead/typeahead.bundle.min.js"></script>
    <script src="<?php echo base_url() ?>global_assets/js/plugins/forms/inputs/typeahead/handlebars.min.js"></script>
	...
	<script src="<?php echo base_url() ?>global_assets/js/plugins/forms/inputs/maxlength.min.js"></script>
    <script src="<?php echo base_url() ?>global_assets/js/plugins/forms/inputs/formatter.min.js"></script>
	<script src="<?php echo base_url() ?>global_assets/js/plugins/uploaders/dropzone.min.js"></script>
...
.topemenuwti {
   /*  background-image:
        url("<?php echo base_url() ?>global_assets/images/header1.jpg");
