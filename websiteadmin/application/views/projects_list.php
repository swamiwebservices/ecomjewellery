                    ...
                    <div class="card  ">
						...
						<table width="100%" class="table">
		                    <thead>
		                        <tr>
		                            <th width="2%">#</th>
		                            <th width="13%">Projet Title</th>
		                            <th width="18%">Project For</th>
		                            <th width="30%">Price</th>
		                            <th width="12%">Documents</th>
		                            <th width="13%">Investers</th>
		                    ...
		                    <tbody>
		                        ...
		                        <tr class="<?php if($status=="Active"){?>table-success<?php } else { ?>table-danger<?php } ?>">
		                            ...
		                            <td valign="top"><a href="#"><strong><?php echo $this->common->getDbValue($value['name']); ?></strong></a></td>
		                            <td valign="top"><a href="#"><strong><?php echo $this->common->getDbValue($value['name']); ?></strong></a></td>
		                            <td valign="top"><a href="#"><strong><?php echo $this->common->getDbValue($value['name']); ?></strong></a></td>
		                            <td valign="top"><a href="#">DOCS [5]</a></td>
		                            <td valign="top"><a href="#">INVSTRS [8]</a></td>
		                            <td valign="top">
                                        <?php
                              ...
                              <div class="list-icons">
                                            <a href="<?php echo site_url($this->ctrl_name.'/edit_project/'.$this->common->getDbValue($value['proj_id'])) ?>" class="list-icons-item text-primary-600" data-popup="tooltip" title="" data-original-title="Edit"><i class="icon-pencil7"></i></a>
