...
if ($status == "Inactive") {echo '<span class="badge badge-light">Inactive</span>';}
        ?>
                                    ...
                                    <td class="text-center">
                                        ...
                                        <a href="<?php echo site_url($controller . '/addzonearea/' . $value['id']) ?>" class="list-icons-item text-primary-600 " data-popup="tooltip" title="" data-original-title="Add zone area"><i class="icon-add"></i></a> |    <a href="<?php echo site_url($controller . '/editcity/' . $value['id']) ?>" class="list-icons-item text-primary-600 ml-2" data-popup="tooltip" title="" data-original-title="Edit"><i class="icon-pencil7"></i></a> |     <a href="#" class="list-icons-item text-danger-600 ml-2 bootbox_custom" data-uuid="<?php echo $value['id'] ?>" data-popup="tooltip" title="" data-original-title="Delete"><i class="icon-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php }?>
