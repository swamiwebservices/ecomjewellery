...
if ($warning) {
    ?>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="frm-edit" id="frm-edit" action="<?php echo site_url($controller . '/addzonearea/'.$cityid) ?>" method="post" enctype="multipart/form-data">
        ...
        ?>
                                    ...
                                    <td class="text-center">
                                        <div class="list-icons">
                                              <a href="<?php echo site_url($controller . '/editzonearea/'.$cityid.'/' . $value['id']) ?>" class="list-icons-item text-primary-600 ml-2" data-popup="tooltip" title="" data-original-title="Edit"><i class="icon-pencil7"></i></a> | <a href="#" class="list-icons-item text-danger-600 ml-2 bootbox_custom" data-cityid="<?php echo $cityid ?>"  data-uuid="<?php echo $value['id'] ?>" data-popup="tooltip" title="" data-original-title="Delete"><i class="icon-trash"></i></a>
                                        </div>
                                    </td>
                                </tr>
                                <?php }?>
