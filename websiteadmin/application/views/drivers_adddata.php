                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="frm-edit" id="frm-edit" action="<?php echo site_url($controller . '/adddata/') ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="first_name">Moddle Name :</label>
                                    <div class="col-lg-9"><input type="text" class="form-control" id="middle_name" name="middle_name" placeholder="" value="<?php echo isset($records['middle_name']) ? $this->common->getDbValue($records['first_name']) : ''; ?>">
...
<div class="form-group row">
                                ...
                                <!-- <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="personal_mobile_number">Personal Mobile :</label>
                                    <div class="col-lg-9"><input type="text" class="form-control" id="personal_mobile_number" name="personal_mobile_number" placeholder="" value="<?php echo isset($records['personal_mobile_number']) ? $this->common->getDbValue($records['personal_mobile_number']) : ''; ?>" required1> </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-form-label col-lg-2" for="state_id">Personal Address :</label>
                                    <div class="col-lg-9"><input type="text" class="form-control " id="personal_address" name="personal_address" placeholder="" value="<?php echo isset($records['personal_address']) ? $this->common->getDbValue($records['personal_address']) : ''; ?>" required1> </div>
                                </div> -->
                                <div class="form-group row">
