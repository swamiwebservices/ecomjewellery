                            ...
                            <tbody>
                             ...
                             //   $sql = " and (parent_id = '".$value['user_id']."')";
                                ...
                                <tr class="  border-left-3  <?php echo ($status == "Active") ? 'border-left-success' : 'border-left-danger' ?>  tr<?php echo $this->common->getDbValue($value['status']); ?>">
                                    ...
                                    <td valign="top">
                                    <a href="<?php echo site_url('customers/view_customer/'.$this->common->getDbValue($value['user_id'])) ?>" target='_blank'  class="list-icons-item text-primary-600" data-popup="tooltip" title="" data-original-title="VIEW"><?php echo $this->common->getDbValue($value['first_name']); ?>
                                    ...
                                    <td valign="top"><?php echo $this->common->getDbValue($value['postcode']); ?></td>

                                    <td valign="top"><?php echo $this->common->getDbValue($value['address_1']); ?></td>
