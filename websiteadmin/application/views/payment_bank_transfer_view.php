                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="<?php echo site_url($controller.'')?>" method="post" enctype="multipart/form-data"
                            ...
                            <input type="hidden" name="bank_transfer_geo_zone_id" value="0">
                            <input type="hidden" name="bank_transfer_order_status_id" value="1">
                            <input type="hidden" name="bank_transfer_total" value="1">

                            <div class="form-group row">
                                <label class="col-sm-2 control-label" for="input-bank">Bank Transfer
                                    Instructions</label>
                                <div class="col-sm-10">
                                    <div class="input-group">
                                        <textarea name="bank_transfer_bank" required cols="80" rows="10"
                                            placeholder="Bank Transfer Instructions" id="input-bank"
                                            class="form-control"><?php echo isset($records['bank_transfer_bank']) ? $records['bank_transfer_bank'] : ''; ?></textarea>
                                    </div>
                            ...
                            <!-- <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="bank_transfer_sort_order"
                                        value="<?php echo isset($records['bank_transfer_sort_order']) ? $records['bank_transfer_sort_order'] : ''; ?>"
                                        placeholder="Sort Order" id="input-sort-order" class="form-control" />
                                </div>
                            </div> -->
                            <input type="hidden" name="bank_transfer_sort_order"
                                        value="<?php echo isset($records['bank_transfer_sort_order']) ? $records['bank_transfer_sort_order'] : ''; ?>"
                                        placeholder="Sort Order" id="input-sort-order" class="form-control" />
                            <div class="form-group row">
