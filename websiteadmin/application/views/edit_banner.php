            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="frm-edit" id="frm-edit" action="<?php echo site_url($this->ctrl_name.'/edit_banner/'.$id) ?>" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9"><input type="text" class="form-control  alhanumeric" id="title" name="title" placeholder="Title" value="<?php echo isset($records['title'])?$this->common->getDbValue($records['title']):''; ?>">
								...
								<div class="form-group row">
                                    ...
                                    <?php 
										if($records['banner_image']!=''){
											$photo = base_url().'uploads/banner_images/'.stripslashes($records['banner_image']);
										} else {
