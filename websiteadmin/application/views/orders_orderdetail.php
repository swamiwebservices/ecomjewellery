...
foreach ($products as $product) {?>
                                            <tr>
                                                <td class="text-left"> <img src="<?php echo $this->common->showImage('../uploads/prod_images/', $product['main_image']); ?>" width="50">
                                                <p><span><?php echo $this->common->getDbValue($product['name']); ?></span></p> 
                                                </td>
                                                <td class="text-left"><p><?php echo $product['quantity']; ?></p></td>
                                                <td class="text-left"><p><?php echo $product['price']; ?></p></td>
                                                <td class="text-left "><p><?php echo $product['total']; ?></p></td>
                                            </tr>
                                            <?php }?>
                                            <?php }?>
                                            <?php
...
?>
                                            ...
                                            <div class="row pt-2">
                                                <div class="col-12 col-sm-12 col-lg-12">
                                                    ...
                                                    <form class="form-horizontal" action="<?php echo site_url($controller) ?>/orderdetail/<?php echo $order_uuid; ?>?page=<?php echo (isset($page))?$page:''?>" name="updateOrderStatus" id="updateOrderStatus" method="post">
                                                       ...
                                                       <!--  <div class="form-group row">
                                                            <label class="col-form-label col-lg-3" for="input-notify">Notify Customer</label>
                                                            <div class="col-lg-9">
                                                                <input type="checkbox" name="notify" value="1" id="input-notify" />
                                                            </div>
                                                        </div> -->
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-lg-3" for="input-comment">Comment</label>
                                                            <div class="col-lg-9">
                                                                <textarea name="comment" rows="2" id="input-comment" class="form-control"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row">
                                                            <label class="col-form-label col-lg-3" for="input-Status"> </label>
                                                            <div class="col-lg-9">
                                                                <?php
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                <div class="col-12">
                                <?php if (isset($driver_order_recieved_list) && $driver_order_recieved_list) {?>
                                    <h3>Order Sent</h3>
                                    <table class="table table-bordered table-hover">
                                        <thead>
                                            <tr class="bg-blue ">
                                        ...
                                        <tbody>
                                            <?php if ($driver_order_recieved_list) {?>
                                            <?php foreach ($driver_order_recieved_list as $key => $value) {
                                                $status  = $value['status'];
                                                ?>
                                            <tr class="<?php echo ($status==1)?'bg-success' :'' ?> <?php echo ($status==2)?'bg-warning' :'' ?>">
                                                <td class="text-left"><?php echo $value['first_name']; ?> <?php echo $value['last_name']; ?></td>
