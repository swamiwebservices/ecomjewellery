			...
			if($error==""){
                if (isset($_FILES['main_image']['name']) && $_FILES['main_image']['name'] != '') {
                    ...
                    if ($upload['uploaded'] == 'false') {
                        ...
                        $this->kishoreimagelib->load($image_old_path_only . $add_in_m['main_image'])->set_background_colour("#dfdfdf")->resize(250, 250, true)->save($image_old_path_only .  $add_in_m['main_image']);
