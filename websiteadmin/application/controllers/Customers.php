...
// inner join user_master_front um on o.customer_id = cm.user_id
        $sSql = "SELECT cm.*,a.address_1,a.address_2, a.postcode ,mc.name as country_name, mz.name as state_name  FROM `m_customer` cm
    ...
    public function view_customer($uuid = 1)
    {
        $data['msg'] = '';
        $data['id'] = $uuid;
        $data['l_s_act'] = 2;
        ...
        if (isset($_POST['mode_pop']) && $_POST['mode_pop'] == "frmChangePassword") {
            ...
            if ($error == '') {
                ...
                redirect($this->ctrl_name . '/view_customer/' . $uuid . "?tab=2");
            }
        }
