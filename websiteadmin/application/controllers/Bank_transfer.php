...
class Bank_transfer extends CI_Controller {
	  ...
	  public $title = "Patment bank transfer";
	...
	public function index() {
	 ...
	 $data['back_link'] = 'payment';
	  if(isset($_POST['mode']) && $_POST['mode']=='edit_content'){
		...
		$data['order_statuses'] = $order_statuses = $this->common->getAllRow( 'm_order_status' , $where_cond);
	...
	//	print_r($data['records']);
		$data['sub_heading'] = 'Edit Bank Transfer'; 
